...
class TestEtlProgramasOrquestrador(TestCase):
    """Testes para o orquestrador assíncrono de Programas."""
    ...
    def test_get_meta_fase_3(self) -> None:
        ...
        orq = self._make_orquestrador()
        meta = orq.service.get_meta(orq.service._fases[2], 3, 5, orq.id_execucao)
